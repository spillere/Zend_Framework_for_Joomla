 ...
 */
require_once (JPATH_LIBRARIES.DS.'zend'.DS.'Validate'.DS.'Abstract.php');
 ...
 */
require_once (JPATH_LIBRARIES.DS.'zend'.DS.'Validate'.DS.'Ip.php');
...
class Zend_Validate_Hostname extends Zend_Validate_Abstract
{
    ...
    protected $_validIdns = array(
        ...
        'CN'  => 'Hostname/Cn.php',
        'COM' => "JPATH_LIBRARIES/zend/Validate/Hostname/Com.php",
        ...
        'NET' => "JPATH_LIBRARIES/zend/Validate/Hostname/Com.php",
        'NO'  => array(1 => '/^[\x{002d}0-9a-zàáä-éêñ-ôöøüčđńŋšŧž]{1,63}$/iu'),
        'NU'  => "JPATH_LIBRARIES/zend/Validate/Hostname/Com.php",
                ...
                if (preg_match('/([^.]{2,10})$/i', end($domainParts), $matches) ||
                    ...
                    if ($this->_validateIdn &&  isset($this->_validIdns[strtoupper($this->_tld)])) {
                        if (is_string($this->_validIdns[strtoupper($this->_tld)])) {
                            include(JPATH_LIBRARIES."/zend/Validate/Hostname/Com.php");
                        } else {
                    ...
                    foreach ($domainParts as $domainPart) {
                        ...
                        foreach($regexChars as $regexKey => $regexChar) {
                            ...
                            if ($status === false) {
                                require_once (JPATH_LIBRARIES.DS.'zend'.DS.'Validate'.DS.'Exception.php');
