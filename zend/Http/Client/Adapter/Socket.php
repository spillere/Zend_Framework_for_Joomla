...
require_once (JPATH_LIBRARIES.DS.'zend'.DS.'Uri'.DS.'Http.php');
...
class Zend_Http_Client_Adapter_Socket implements Zend_Http_Client_Adapter_Interface
{
    ...
    {
        if (! is_array($config)) {
				require_once (JPATH_LIBRARIES.DS.'zend'.DS.'Http'.DS.'Adapter'.DS.'Exception.php');            throw new Zend_Http_Client_Adapter_Exception(
            ...
            if ($secure) {
                if ($this->config['sslcert'] !== null) {
                    if (! stream_context_set_option($context, 'ssl', 'local_cert',
                                                    $this->config['sslcert'])) {
                        require_once (JPATH_LIBRARIES.DS.'zend'.DS.'Http'.DS.'Adapter'.DS.'Exception.php');
