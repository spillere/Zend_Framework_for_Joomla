...
$adapterToImport = 'zend.Http.Client.Adapter.Socket';

/**
 * @see Zend_Uri
 */
require_once (JPATH_LIBRARIES.DS.'zend'.DS.'Uri.php');


/**
 * @see Zend_Http_Client_Adapter_Interface
 */
require_once (JPATH_LIBRARIES.DS.'zend'.DS.'Http'.DS.'Client'.DS.'Adapter'.DS.'Interface.php');


/**
 * @see Zend_Http_Response
 */
require_once (JPATH_LIBRARIES.DS.'zend'.DS.'Http'.DS.'Response.php');
...
class Zend_Http_Client
{
    ...
    public function setCookieJar($cookiejar = true)
    {
        if (! class_exists('Zend_Http_CookieJar')) {
            require_once (JPATH_LIBRARIES.DS.'zend'.DS.'Http'.DS.'CookieJar.php');
        }
    ...
    public function setCookie($cookie, $value = null)
    {
        if (! class_exists('Zend_Http_Cookie')) {
            require_once (JPATH_LIBRARIES.DS.'zend'.DS.'Http'.DS.'Cookie.php');
        }
