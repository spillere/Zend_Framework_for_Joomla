 ...
 */
require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'Docs'.DS.'DocumentListFeed.php');

/**
 * @see Zend_Gdata_Docs_DocumentListEntry
 */
require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'Docs'.DS.'DocumentListEntry.php');
