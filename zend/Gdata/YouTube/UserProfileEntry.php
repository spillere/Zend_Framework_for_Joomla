 ...
 */
require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'Entry.php');

/**
 * @see Zend_Gdata_Extension_FeedLink
 */
require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'Extension'.DS.'FeedLink.php');

/**
 * @see Zend_Gdata_YouTube_Extension_Description
 */
require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'YouTube'.DS.'Extension'.DS.'Description.php');

/**
 * @see Zend_Gdata_YouTube_Extension_AboutMe
 */
require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'YouTube'.DS.'Extension'.DS.'AboutMe.php');

/**
 * @see Zend_Gdata_YouTube_Extension_Age
 */
require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'YouTube'.DS.'Extension'.DS.'Age.php');
 ...
 */
require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'YouTube'.DS.'Extension'.DS.'Books.php');

/**
 * @see Zend_Gdata_YouTube_Extension_Company
 */
require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'YouTube'.DS.'Extension'.DS.'Company.php');

/**
 * @see Zend_Gdata_YouTube_Extension_Hobbies
 */
require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'YouTube'.DS.'Extension'.DS.'Hobbies.php');

/**
 * @see Zend_Gdata_YouTube_Extension_Hometown
 */
require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'YouTube'.DS.'Extension'.DS.'Hometown.php');

/**
 * @see Zend_Gdata_YouTube_Extension_Location
 */
require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'YouTube'.DS.'Extension'.DS.'Location.php');

/**
 * @see Zend_Gdata_YouTube_Extension_Movies
 */
require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'YouTube'.DS.'Extension'.DS.'Movies.php');

/**
 * @see Zend_Gdata_YouTube_Extension_Music
 */
require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'YouTube'.DS.'Extension'.DS.'Music.php');

/**
 * @see Zend_Gdata_YouTube_Extension_Occupation
 */
require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'YouTube'.DS.'Extension'.DS.'Occupation.php');

/**
 * @see Zend_Gdata_YouTube_Extension_School
 */
require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'YouTube'.DS.'Extension'.DS.'School.php');

/**
 * @see Zend_Gdata_YouTube_Extension_Gender
 */
require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'YouTube'.DS.'Extension'.DS.'Gender.php');

/**
 * @see Zend_Gdata_YouTube_Extension_Relationship
 */
require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'YouTube'.DS.'Extension'.DS.'Relationship.php');

/**
 * @see Zend_Gdata_YouTube_Extension_FirstName
 */
require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'YouTube'.DS.'Extension'.DS.'FirstName.php');

/**
 * @see Zend_Gdata_YouTube_Extension_LastName
 */
require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'YouTube'.DS.'Extension'.DS.'LastName.php');

/**
 * @see Zend_Gdata_YouTube_Extension_Statistics
 */
require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'YouTube'.DS.'Extension'.DS.'Statistics.php');

/**
 * @see Zend_Gdata_Media_Extension_MediaThumbnail
 */
require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'Media'.DS.'Extension'.DS.'MediaThumbnail.php');
    ...
    public function setAboutMe($aboutMe = null)
    {
        if (($this->getMajorProtocolVersion() == null) ||
           ($this->getMajorProtocolVersion() == 1)) {
			require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'App'.DS.'VersionException.php');
