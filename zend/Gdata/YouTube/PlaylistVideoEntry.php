 ...
 */
require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'YouTube'.DS.'VideoEntry.php');

/**
 * @see Zend_Gdata_YouTube_Extension_Position
 */
require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'YouTube'.DS.'Extension'.DS.'Position.php');
