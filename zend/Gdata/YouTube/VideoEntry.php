 ...
 */
require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'Extension'.DS.'Comments.php');
 ...
 */
require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'YouTube'.DS.'MediaEntry.php');

/**
 * @see Zend_Gdata_YouTube_Extension_MediaGroup
 */
require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'YouTube'.DS.'Extension'.DS.'MediaGroup.php');

/**
 * @see Zend_Gdata_YouTube_Extension_NoEmbed
 */
require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'YouTube'.DS.'Extension'.DS.'NoEmbed.php');
 ...
 */
require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'YouTube'.DS.'Extension'.DS.'Link.php');

/**
 * @see Zend_Gdata_YouTube_Extension_Racy
 */
require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'YouTube'.DS.'Extension'.DS.'Racy.php');

/**
 * @see Zend_Gdata_Extension_Rating
 */
require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'Extension'.DS.'Rating.php');

/**
 * @see Zend_Gdata_Geo_Extension_GeoRssWhere
 */
require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'Geo'.DS.'Extension'.DS.'GeoRssWhere.php');

/**
 * @see Zend_Gdata_YouTube_Extension_Control
 */
require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'YouTube'.DS.'Extension'.DS.'Control.php');

/**
 * @see Zend_Gdata_YouTube_Extension_Recorded
 */
require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'YouTube'.DS.'Extension'.DS.'Recorded.php');
...
class Zend_Gdata_YouTube_VideoEntry extends Zend_Gdata_YouTube_MediaEntry
{
    ...
    public function setVideoRating($ratingValue)
    {
        if ($ratingValue < 1 || $ratingValue > 5) {
            require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'App'.DS.'InvalidArgumentException.php');
