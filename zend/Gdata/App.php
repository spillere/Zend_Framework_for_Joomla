 ...
 * Zend_Gdata_Feed
 */
require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'Feed.php');

/**
 * Zend_Gdata_Http_Client
 */
require_once( JPATH_LIBRARIES.DS.'zend'.DS.'Http'.DS.'Client.php');
 ...
 */
require_once( JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'App'.DS.'MediaSource.php');
...
class Zend_Gdata_App
{
        ...
        $applicationId = 'MyCompany-MyApp-1.0')
    {
        ...
        if (!$client instanceof Zend_Http_Client) {
            require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'App'.DS.'HttpException.php');
        ...
        $body = null, $contentType = null, $remainingRedirects = null)
    {
        ...
        if ($body instanceof Zend_Gdata_MediaMimeStream) {
            ...
            if ($oldHttpAdapter instanceof Zend_Http_Client_Adapter_Proxy) {
                require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'HttpAdapterStreamingProxy.php');
                $newAdapter = new Zend_Gdata_HttpAdapterStreamingProxy();
            } else {
                require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'HttpAdapterStreamingSocket.php');
