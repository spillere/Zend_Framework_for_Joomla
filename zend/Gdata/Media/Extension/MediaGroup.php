 ...
 */
require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'Extension.php');
 ...
 */
require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'Media'.DS.'Extension'.DS.'MediaContent.php');

/**
 * @see Zend_Gdata_Media_Extension_MediaCategory
 */
require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'Media'.DS.'Extension'.DS.'MediaCategory.php');

/**
 * @see Zend_Gdata_Media_Extension_MediaCopyright
 */
require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'Media'.DS.'Extension'.DS.'MediaCopyright.php');

/**
 * @see Zend_Gdata_Media_Extension_MediaCredit
 */
require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'Media'.DS.'Extension'.DS.'MediaCredit.php');

/**
 * @see Zend_Gdata_Media_Extension_MediaDescription
 */
require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'Media'.DS.'Extension'.DS.'MediaDescription.php');

/**
 * @see Zend_Gdata_Media_Extension_MediaHash
 */
require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'Media'.DS.'Extension'.DS.'MediaHash.php');

/**
 * @see Zend_Gdata_Media_Extension_MediaKeywords
 */
require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'Media'.DS.'Extension'.DS.'MediaKeywords.php');

/**
 * @see Zend_Gdata_Media_Extension_MediaPlayer
 */
require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'Media'.DS.'Extension'.DS.'MediaPlayer.php');

/**
 * @see Zend_Gdata_Media_Extension_MediaRating
 */
require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'Media'.DS.'Extension'.DS.'MediaRating.php');

/**
 * @see Zend_Gdata_Media_Extension_MediaRestriction
 */
require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'Media'.DS.'Extension'.DS.'MediaRestriction.php');

/**
 * @see Zend_Gdata_Media_Extension_MediaText
 */
require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'Media'.DS.'Extension'.DS.'MediaText.php');
 ...
 */
require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'Media'.DS.'Extension'.DS.'MediaTitle.php');
