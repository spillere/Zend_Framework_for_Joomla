 ...
 */
require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'DublinCore.php');


/**
 * @see Zend_Gdata_Books_CollectionEntry
 */
require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'Books'.DS.'CollectionEntry.php');

/**
 * @see Zend_Gdata_Books_CollectionFeed
 */
require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'Books'.DS.'CollectionFeed.php');

/**
 * @see Zend_Gdata_Books_VolumeEntry
 */
require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'Books'.DS.'VolumeEntry.php');

/**
 * @see Zend_Gdata_Books_VolumeFeed
 */
require_once(JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'Books'.DS.'VolumeFeed');
