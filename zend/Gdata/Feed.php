 ...
 * @see Zend_Gdata
 */
require_once (JPATH_LIBRARIES.DS.'zend'.DS.'Gdata.php');

/**
 * @see Zend_Gdata_App_Feed
 */
require_once (JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'App'.DS.'Feed.php');
 ...
 */
require_once (JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'Extension'.DS.'OpenSearchTotalResults.php');

/**
 * @see Zend_Gdata_Extension_OpenSearchStartIndex
 */
require_once (JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'Extension'.DS.'OpenSearchStartIndex.php');

/**
 * @see Zend_Gdata_Extension_OpenSearchItemsPerPage
 */
require_once (JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'Extension'.DS.'OpenSearchItemsPerPage.php');
    ...
    protected function takeAttributeFromDOM($attribute)
    {
        ...
        case 'etag':
            ...
            elseif ($this->_etag != $etag) {
                require_once (JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'App'.DS.'IOException.php');
