 ...
 */
require_once (JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'App'.DS.'Entry.php');
 ...
 */
require_once (JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'App'.DS.'Extension'.DS.'Generator.php');

/**
 * @see Zend_Gdata_App_Extension_Icon
 */
require_once (JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'App'.DS.'Extension'.DS.'Icon.php');

/**
 * @see Zend_Gdata_App_Extension_Logo
 */
require_once (JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'App'.DS.'Extension'.DS.'Logo.php');

/**
 * @see Zend_Gdata_App_Extension_Subtitle
 */
require_once (JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'App'.DS.'Extension'.DS.'Subtitle.php');
