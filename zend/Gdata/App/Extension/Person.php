 ...
 */
require_once (JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'App'.DS.'Extension'.DS.'Name.php');

/**
 * @see Zend_Gdata_App_Extension_Email
 */
require_once (JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'App'.DS.'Extension'.DS.'Email.php');

/**
 * @see Zend_Gdata_App_Extension_Uri
 */
require_once (JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'App'.DS.'Extension'.DS.'Uri.php');
