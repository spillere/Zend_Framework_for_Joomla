 ...
 */
require_once (JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'App'.DS.'FeedEntryParent.php');

/**
 * @see Zend_Gdata_App_Extension_Content
 */
require_once (JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'App'.DS.'Extension'.DS.'Content.php');

/**
 * @see Zend_Gdata_App_Extension_Edited
 */
require_once (JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'App'.DS.'Extension'.DS.'Edited.php');

/**
 * @see Zend_Gdata_App_Extension_Published
 */
require_once (JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'App'.DS.'Extension'.DS.'Published.php');

/**
 * @see Zend_Gdata_App_Extension_Source
 */
require_once (JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'App'.DS.'Extension'.DS.'Source.php');

/**
 * @see Zend_Gdata_App_Extension_Summary
 */
require_once (JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'App'.DS.'Extension'.DS.'Summary.php');

/**
 * @see Zend_Gdata_App_Extension_Control
 */
require_once (JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'App'.DS.'Extension'.DS.'Control.php');
