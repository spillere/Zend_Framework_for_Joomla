...
*/
require_once (JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'App'.DS.'Extension'.DS.'Element.php');

/**
 * @see Zend_Gdata_App_Extension_Author
*/
require_once (JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'App'.DS.'Extension'.DS.'Author.php');

/**
 * @see Zend_Gdata_App_Extension_Category
*/
require_once (JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'App'.DS.'Extension'.DS.'Category.php');

/**
 * @see Zend_Gdata_App_Extension_Contributor
*/
require_once (JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'App'.DS.'Extension'.DS.'Contributor.php');

/**
 * @see Zend_Gdata_App_Extension_Id
 */
require_once (JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'App'.DS.'Extension'.DS.'Id.php');

/**
 * @see Zend_Gdata_App_Extension_Link
 */
require_once (JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'App'.DS.'Extension'.DS.'Link.php');

/**
 * @see Zend_Gdata_App_Extension_Rights
 */
require_once (JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'App'.DS.'Extension'.DS.'Rights.php');

/**
 * @see Zend_Gdata_App_Extension_Title
 */
require_once (JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'App'.DS.'Extension'.DS.'Title.php');

/**
 * @see Zend_Gdata_App_Extension_Updated
 */
require_once (JPATH_LIBRARIES.DS.'zend'.DS.'Gdata'.DS.'App'.DS.'Extension'.DS.'Updated.php');

/**
 * Zend_Version
 */
require_once (JPATH_LIBRARIES.DS.'zend'.DS.'Version.php');
